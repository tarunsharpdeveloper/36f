...
//    }
    ...
    function Validate()
    {
        ...
        var y = document.new_timesheet.phone.value;
...
//        $('#new_timesheet_form').parsley().on('field:validated', function () {
//
...
//    });
    $("#new_timesheetCardPanel").removeClass("panelWait");
    hideWait();
    function initMap() {
