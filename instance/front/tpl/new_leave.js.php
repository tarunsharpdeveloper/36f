...
//        alert("OK");
        var sdate = $("#f_date").val();
        var stime = $("#f_time").val();
        var etime = $("#l_time").val();
        var edate = $("#l_date").val();
        if ($("#f_date").val() === "") {
            $("#f_date").focus();
        } else if ($("#l_date").val() === "") {
            $("#l_date").focus();
...
//        alert("A");
        $.ajax({
            ...
            type: "post",
            dataType: 'json',
            data: {addleave: 1, ladelData: $("#new_leave_form").serialize()},
            success: function () {
                Materialize.toast('Success! - Label has been saved!', 3000);
//                setTimeout(function () {
//                    window.location.href = "<?php echo _U ?>preferences";
//                }, 4000);
            }
        });
    }
...
//    }
    ...
    function Validate()
    {
        ...
        var y = document.new_leave.phone.value;
...
//        $('#new_leave_form').parsley().on('field:validated', function () {
//
...
//    });
    $("#new_leaveCardPanel").removeClass("panelWait");
    hideWait();
    function initMap() {
